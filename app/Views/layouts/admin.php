  ...
  <aside class="admin-nav">
    <div>
      ...
      <nav>
        ...
        <a class="<?= $section==='orders'?'active':'' ?>" href="<?= base_url('admin/orders') ?>"><svg viewBox="0 0 24 24"><path d="M6 3h12v18l-3-2-3 2-3-2-3 2V3Z"></path><path d="M9 8h6M9 12h6"></path></svg><span>Orders</span></a>
